...
local function create_pywal_theme()
  ...
  -- Setting background color for the current line and column
  vim.api.nvim_set_hl(0, "CursorLine", {
    bg = colors.color4 -- Changed to a different color for visibility
  })
  vim.api.nvim_set_hl(0, "CursorColumn", {
    bg = colors.color4 -- Changed to a different color for visibility
  })

  -- Visual (for selected text using v, V, Ctrl+v)
  vim.api.nvim_set_hl(0, "Visual", {
    bg = colors.color6, -- Changed to a different color for visibility
    fg = colors.background,
  })
  vim.api.nvim_set_hl(0, "VisualNOS", {
    bg = colors.color6, -- Apply the same to VisualNOS (no operator pending)
    fg = colors.background, -- Optional: Change the foreground color of selected text
  })
